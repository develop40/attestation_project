...
class Feature extends BaseObject {
   ...
   * of css, or a function that takes a resolution and returns an array of
   * css. If it is `null` the feature has no style (a `null` style).
 ...
 *     A feature style function, a single style, or an array of css.
