 ...
 * image and text css, and the priority is defined by the z-index of the style. Lower z-index
...
class VectorLayer extends Layer {
  ...
  * of css, or a function that takes a feature and resolution and returns
  * an array of css. If it is `undefined` the default style is used. If
  * it is `null` the layer has no style (a `null` style), so only features
  * that have their own css will be rendered in the layer. See
