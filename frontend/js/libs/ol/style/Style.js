 ...
 *    })
 *  ];
 *  css[GeometryType.MULTI_POLYGON] =
 *      css[GeometryType.POLYGON];
 *  css[GeometryType.LINE_STRING] = [
 *    new Style({
 *      stroke: new Stroke({
 *        color: white,
 *        width: width + 2
 ...
 *    })
 *  ];
 *  css[GeometryType.MULTI_LINE_STRING] =
 *      css[GeometryType.LINE_STRING];
 *  css[GeometryType.POINT] = [
 *    new Style({
 *      image: new Circle({
 *        radius: width * 2,
 *        fill: new Fill({
 ...
 *    })
 *  ];
 *  css[GeometryType.MULTI_POINT] =
 *      css[GeometryType.POINT];
 *  css[GeometryType.GEOMETRY_COLLECTION] =
 *      css[GeometryType.POLYGON].concat(
 *          css[GeometryType.LINE_STRING],
 *          css[GeometryType.POINT]
 *      );
 * ```
...
/**
 * @classdesc
 * Container for vector feature rendering css. Any changes made to the style
 ...
 *     A style function, a single style, or an array of css.
...
/**
 * Default css for editing features.
