...
class CanvasImmediateRenderer extends VectorContext {
   ...
   * the current fill and stroke css.
   *
   ...
   * uses the current css appropriate for each geometry in the collection.
   *
   ...
   * either fill or stroke css, pass null for the appropriate parameter.
   *
