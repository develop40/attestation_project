 ...
 * @property {boolean} [extractStyles=true] Extract css from the KML.
 * @property {boolean} [showPointNames=true] Show names as labels for placemarks which contain points.
 * @property {Array<module:ol/style/Style>} [defaultStyle] Default style. The
 * default default style is the same as Google Earth.
 * @property {boolean} [writeStyles=true] Write css into KML.
 */
 ...
 * @param {!Object<string, (Array<module:ol/style/Style>|string)>} sharedStyles Shared css.
...
function writePlacemark(node, feature, objectStack) {
  ...
  if (styleFunction) {
    // FIXME the css returned by the style function are supposed to be
